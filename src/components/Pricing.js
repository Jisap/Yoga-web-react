      ...
      <div className="container mx-auto">
        ...
        <div className='text-center mb-7 lg:mb-[70px]'>
          ...
          <p 
            ...
            data-aos-delay='700'  
          >
            Pick a pricing plan a get started your journey with us for build your body and mind
          </p>
        </div>
        ...
        <div className='flex flex-col mx-auto items-center gap-y-5 lg:flex-row lg:gap-x-[33px]'>
          { pricing.map(( card, currentIndex ) => {
            ...
            const { BsTextIndentLeft, price, list, buttonIcon, buttonText, delay, title } = card
